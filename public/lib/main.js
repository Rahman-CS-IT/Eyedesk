...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
	...
	function k(l) {
		((!l.__d && (l.__d = !0) && u.push(l) && !b$1.__r++) ||
			t !== n.debounceRendering) &&
			((t = n.debounceRendering) || i$1)(b$1);
	}
	function b$1() {
		for (var n; (b$1.__r = u.length); )
			...
			if (
				...
				(k = u.__k[h] =
					null == (k = l[h]) || "boolean" == typeof k
						...
						: Array.isArray(k)
						? v$1(y, { children: k }, null, null, null)
						: k.__b > 0
	...
	function P$1(n, l, u) {
		"-" === l[0]
			? n.setProperty(l, u)
			: (n[l] =
					null == u ? "" : "number" != typeof u || e$1.test(l) ? u : u + "px");
	}
	function C$1(n, l, u, i, t) {
		...
		n: if ("style" === l)
			if ("string" == typeof u) n.style.cssText = u;
				...
				if (u) for (l in u) (i && u[l] === i[l]) || P$1(n.style, l, u[l]);
			}
		else if ("o" === l[0] && "n" === l[1])
			(o = l !== (l = l.replace(/Capture$/, ""))),
				...
				(n.l[l + o] = u),
				u
					? i || n.addEventListener(l, o ? H$1 : $$1, o)
					: n.removeEventListener(l, o ? H$1 : $$1, o);
			...
			n: if ("function" == typeof P) {
				if (
					...
					null != P.getDerivedStateFromProps &&
						(v.__s == v.state && (v.__s = c$1({}, v.__s)),
						c$1(v.__s, P.getDerivedStateFromProps(g, v.__s))),
					(d = v.props),
					(_ = v.state),
					h)
				)
	...
	function j$2(n, l, u, i, t, o, e, c) {
		...
		if (("svg" === _ && (t = !0), null != o))
			for (; k < o.length; k++)
				if (
					(a = o[k]) &&
					(a === n || (_ ? a.localName == _ : 3 == a.nodeType))
				) {
					(n = a), (o[k] = null);
					break;
				}
		...
		if (null === _) p === d || (c && n.data === d) || (n.data = d);
			...
			if (
				((o = o && f$1.slice.call(n.childNodes)),
				(v = (p = u.props || r$1).dangerouslySetInnerHTML),
			...
			c ||
				("value" in d &&
					...
					C$1(n, "value", k, p.value, !1),
				"checked" in d &&
					void 0 !== (k = d.checked) &&
					k !== n.checked &&
					C$1(n, "checked", k, p.checked, !1));
		}
		return n;
	}
	function z(l, u, i) {
	...
	function L$1(l, u, i) {
		...
		if ((t = l.__k)) for (r = 0; r < t.length; r++) t[r] && L$1(t[r], u, i);
		null != o && s(o);
	}
	function M$1(n, l, u) {
		...
		(p.prototype.setState = function (n, l) {
			...
			(u =
				null != this.__s && this.__s !== this.state
					? this.__s
					: (this.__s = c$1({}, this.state))),
				"function" == typeof n && (n = n(c$1({}, u), this.props)),
				n && c$1(u, n),
	...
	(n.__b = function (n) {
		...
		(n.diffed = function (t) {
			...
			o &&
				o.__H &&
				o.__H.__h.length &&
				((1 !== i.push(o) && r === n.requestAnimationFrame) ||
					(
		...
		(t.componentWillUnmount = function () {
			...
			n.__v
				? (t.l ||
				  ...
				  N(a$1(T, { context: t.context }, n.__v), t.l))
				: t.l && t.componentWillUnmount();
	}
	function I(n, t) {
		return a$1(j, { __v: n, i: t });
	}
	((F.prototype = new p()).__e = function (n) {
		var t = this,
			e = U(t.__v),
			r = t.o.get(n);
		return (
		...
		(F.prototype.componentDidUpdate = F.prototype.componentDidMount =
			function () {
				var n = this;
	...
	n.vnode = function (n) {
		...
		if ("string" == typeof t) {
			...
			"select" == t &&
				...
				(r.value = w$1(e.children).forEach(function (n) {
    ...
    */
	...
	function buildEventSourceRefiners(context) {
		return __assign(
			__assign(__assign({}, EVENT_UI_REFINERS), EVENT_SOURCE_REFINERS$1),
    ...
    */
	...
	function computeClippedClientRect(el) {
		...
		var rect = el.getBoundingClientRect();
		for (
			var _i = 0, clippingParents_1 = clippingParents;
			_i < clippingParents_1.length;
			_i++
		) {
			var clippingParent = clippingParents_1[_i];
			var intersection = intersectRects(
				rect,
	...
	var PureComponent = /** @class */ (function (_super) {
		...
		PureComponent.prototype.safeSetState = function (newState) {
			if (
				!compareObjs(
					this.state,
					__assign(__assign({}, this.state), newState),
					this.stateEquality
				)
			) {
    ...
    */
	...
	function parseToolbars(
		...
		var header = calendarOptions.headerToolbar
			? parseToolbar(
			...
			: null;
		var footer = calendarOptions.footerToolbar
			? parseToolbar(
	...
	function parseToolbar(
		...
		for (var sectionName in sectionStrHash) {
			...
			viewsWithButtons.push.apply(
				viewsWithButtons,
				sectionRes.viewsWithButtons
			);
	...
	function buildDomNodeRenderer() {
		...
		function render(el, domNodes) {
			...
			if (el !== currentEl || !isArraysEqual(currentDomNodes, newDomNodes)) {
				...
				for (
					var _i = 0, newDomNodes_1 = newDomNodes;
					_i < newDomNodes_1.length;
					_i++
				) {
    ...
    */
	...
	var SegHierarchy = /** @class */ (function () {
		...
		SegHierarchy.prototype.isInsertionValid = function (insertion, entry) {
			return (
				(this.maxCoord === -1 ||
					insertion.levelCoord + entry.thickness <= this.maxCoord) &&
				(this.maxStackCnt === -1 || insertion.stackCnt < this.maxStackCnt)
			);
		};
		// returns number of new entries inserted
		SegHierarchy.prototype.handleInvalidInsertion = function (
			insertion,
			entry,
			hiddenEntries
		) {
		...
		SegHierarchy.prototype.splitEntry = function (
			entry,
			barrier,
			hiddenEntries
		) {
		...
		SegHierarchy.prototype.findInsertion = function (newEntry) {
			...
			for (
				...
				if (
					!strictOrder &&
					trackingCoord >= candidateCoord + newEntry.thickness
				) {
					break;
				}
				...
				var searchRes = binarySearch(
					...
					newEntry.span.start,
					getEntrySpanEnd
				); // find first entry after newEntry's end
			...
			if (touchingEntry) {
				...
				while (
					destLevel < levelCnt &&
					levelCoords[destLevel] < candidateCoord
				) {
					destLevel += 1;
				}
			}
	...
	var ToolbarSection = /** @class */ (function (_super) {
		...
		ToolbarSection.prototype.render = function () {
			...
			return createElement.apply(
				void 0,
				__spreadArray(["div", { className: "fc-toolbar-chunk" }], children)
			);
		};
		ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
			...
			if (children.length > 1) {
				...
				return createElement.apply(
					void 0,
					__spreadArray(["div", { className: groupClassName }], children)
				);
			}
			return children[0];
		};
	...
	var Slicer = /** @class */ (function () {
		...
		Slicer.prototype.sliceProps = function (
			...
			return {
				dateSelectionSegs: this.sliceDateSelection.apply(
					this,
					__spreadArray([props.dateSelection, eventUiBases, context], extraArgs)
				),
		...
		Slicer.prototype._sliceDateSpan = function (
			...
			var segs = this.sliceRange.apply(
				this,
				__spreadArray([dateSpan.range], extraArgs)
			);
        ...
        */
		Slicer.prototype.sliceEventRange = function (eventRange, extraArgs) {
			...
			var segs = this.sliceRange.apply(
				this,
				__spreadArray([dateRange], extraArgs)
			);
				...
				function (rootElRef, dayClassNames, dataAttrs) {
					return createElement(
						Popover,
						{
							...
							extraAttrs:
								dataAttrs /* TODO: make these time-based when not whole-day? */,
    ...
    */
	var AutoScroller = /** @class */ (function () {
		...
		AutoScroller.prototype.computeBestEdge = function (left, top) {
			...
			for (
				var _i = 0, scrollCaches_1 = scrollCaches;
				_i < scrollCaches_1.length;
				_i++
			) {
    ...
    */
	...
	var TableRow = /** @class */ (function (_super) {
		...
		TableRow.prototype.renderFgSegs = function (
			...
			if (framePositions) {
				for (
					var _i = 0, segPlacements_1 = segPlacements;
					_i < segPlacements_1.length;
					_i++
				) {
		...
		TableRow.prototype.updateSizing = function (isExternalSizingChange) {
			...
			if (
				...
				this.safeSetState({
					...
					eventInstanceHeights: __assign(
						__assign({}, oldInstanceHeights),
						newInstanceHeights
					),
		...
		TableRow.prototype.queryEventInstanceHeights = function () {
			...
			for (var key in segElMap) {
				...
				eventInstanceHeights[instanceId] = Math.max(
					eventInstanceHeights[instanceId] || 0,
					height
				);
			}
	...
	function buildAbsoluteTopHash(colPlacements) {
		...
		for (
			var _i = 0, colPlacements_1 = colPlacements;
		...
		Table.prototype.queryHit = function (positionLeft, positionTop) {
			...
			if (row != null && col != null) {
				...
				return {
					...
					dateSpan: __assign(
						{ range: this.getCellRange(row, col), allDay: true },
						cell.extraDateSpan
					),
		...
		function TimeColsView() {
			...
			_this.renderHeadAxis = function (rowKey, frameHeight) {
				...
				if (options.weekNumbers && rowKey === "day") {
					return createElement(
						WeekNumberRoot,
						{ date: range.start, defaultFormat: DEFAULT_WEEK_NUM_FORMAT },
						function (rootElRef, classNames, innerElRef, innerContent) {
							return createElement(
								"th",
								{
		...
		var stretchNode = cacheable(
			...
			function (node, startCoord, prevThickness) {
				...
				if (!nextLevelNodes.length) {
					...
					for (
						var _i = 0, nextLevelNodes_1 = nextLevelNodes;
						_i < nextLevelNodes_1.length;
						_i++
					) {
	...
	var TimeCol = /** @class */ (function (_super) {
		...
		TimeCol.prototype.render = function () {
			...
			var interactionAffectedInstances = // TODO: messy way to compute this
				...
				(props.eventResize && props.eventResize.affectedInstances) ||
				{};
			var sortedFgSegs = this.sortEventSegs(
				props.fgEventSegs,
		...
		TimeCol.prototype.renderPositionedFgSegs = function (
			segs, // if not mirror, needs to be sorted
			segIsInvisible,
			isDragging,
			isResizing,
			isDateSelecting
			...
			var _b = this.props,
				...
				nowDate = _b.nowDate;
			var isMirror = isDragging || isResizing || isDateSelecting;
			var segVCoords = computeSegVCoords(
				segs,
				date,
				slatCoords,
				eventMinHeight
			);
			var _c = computeFgSegPlacements(
					segs,
					segVCoords,
					eventOrderStrict,
					eventMaxStack
				...
				segPlacements.map(function (segPlacement) {
					...
					return createElement(
						"div",
						{
							...
							key: instanceId,
							style: __assign(
								__assign({ visibility: isVisible ? "" : "hidden" }, vStyle),
								hStyle
							),
						},
						createElement(
		...
		TimeCol.prototype.renderHiddenGroups = function (hiddenGroups, segs) {
			...
			return createElement(
				Fragment,
				null,
				hiddenGroups.map(function (hiddenGroup) {
		...
		TimeCols.prototype.queryHit = function (positionLeft, positionTop) {
			...
			if (colIndex != null && slatIndex != null) {
				...
				return {
					dateProfile: dateProfile,
					dateSpan: __assign(
						{ range: { start: start, end: end }, allDay: false },
						cell.extraDateSpan
					),
			...
			var hookProps = __assign(
				{
					...
					sideNavLinkAttrs: buildNavLinkAttrs(
						this.context,
						dayDate,
						"day",
						false
		...
		return createElement(
			...
			props.text &&
				createElement(
					"a",
					__assign(
						{ id: props.textId, className: "fc-list-day-text" },
						props.navLinkAttrs
					),
					props.text
				),
			props.sideText &&
				/* not keyboard tabbable */ createElement(
					"a",
					__assign(
						{ "aria-hidden": true, className: "fc-list-day-side-text" },
    ...
    */
					...
					return createElement(
						...
						createElement(
							...
							createElement(
								...
								createElement(
									"th",
									{ scope: "col", id: timeHeaderId },
									options.timeHint
								),
								createElement("th", { scope: "col", "aria-hidden": true }),
								createElement(
									"th",
									{ scope: "col", id: eventHeaderId },
									options.eventHint
								)
							)
						),
	...
	BootstrapTheme$1.prototype.iconOverrideCustomButtonOption =
	...
	var eventSourceDef = {
		...
		fetch: function (arg, onSuccess, onFailure) {
			...
			if (!apiKey) {
				...
				var requestParams_1 = buildRequestParams(
					arg.range,
					apiKey,
					extraParamsObj,
					dateEnv
