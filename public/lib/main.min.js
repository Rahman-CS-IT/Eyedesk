...
var FullCalendar = (function (e) {
	...
	function b(e) {
		((!e.__d && (e.__d = !0) && a.push(e) && !D.__r++) ||
			l !== i.debounceRendering) &&
			((l = i.debounceRendering) || s)(D);
	}
	function D() {
		...
		for (n.__k = [], p = 0; p < t.length; p++)
			if (
				...
				if (
					((v.__ = n),
					(v.__b = n.__b + 1),
					null === (h = D[p]) || (h && v.key == h.key && v.type === h.type))
				)
					D[p] = void 0;
				else
					for (f = 0; f < C; f++) {
	...
	function k(e, t, n, r, o) {
		...
		e: if ("style" === t)
			...
			(i = t !== (t = t.replace(/Capture$/, ""))),
				...
				(e.l[t + i] = n),
				n
					? r || e.addEventListener(t, i ? M : x, i)
					: e.removeEventListener(t, i ? M : x, i);
	...
	function I(e, t, n, r, o, a, s, l, u) {
		...
		null != n.__h &&
			((u = n.__h), (l = t.__e = n.__e), (t.__h = null), (a = [l])),
			(c = i.__b) && c(t);
		try {
			e: if ("function" == typeof R) {
				if (
					...
					if (
						(null == R.getDerivedStateFromProps &&
							...
							d.componentWillReceiveProps(S, D),
						(!d.__e &&
							null != d.shouldComponentUpdate &&
							!1 === d.shouldComponentUpdate(S, d.__s, D)) ||
							t.__v === n.__v)
					) {
						(d.props = S),
							(d.state = d.__s),
				...
				(d.context = D),
					...
					p ||
						...
						(g = d.getSnapshotBeforeUpdate(h, v)),
					(w =
						null != c && c.type === m && null == c.key ? c.props.children : c),
			...
			(t.__v = null),
				(u || null != a) &&
					((t.__e = l), (t.__h = !!u), (a[a.indexOf(l)] = null)),
				i.__e(e, t, n);
		}
	}
	function P(e, t) {
	...
	function N(e, t, n, r, o, i, a, s) {
		...
		if (("svg" === m && (o = !0), null != i))
			for (; y < i.length; y++)
				if (
					(l = i[y]) &&
					(l === e || (m ? l.localName == m : 3 == l.nodeType))
				) {
					(e = l), (i[y] = null);
					break;
				}
		...
		if (null === m) v === g || (s && e.data === g) || (e.data = g);
			...
			s ||
				("value" in g &&
					...
					k(e, "value", y, v.value, !1),
				"checked" in g &&
					void 0 !== (y = g.checked) &&
					y !== e.checked &&
					k(e, "checked", y, v.checked, !1));
		}
		return e;
	}
	function H(e, t, n) {
	...
	ge.FullCalendarVDom
		...
		: (ge.FullCalendarVDom = {
				...
				flushSync: function (e) {
					...
					(i.debounceRendering = r),
						L(v(me, {}), document.createElement("div"));
	...
	function Fe(e) {
		e.classList.remove("fc-unselectable"),
			e.removeEventListener("selectstart", Me);
	}
	function Be(e) {
	...
	function xt(e, t, n) {
		...
		a)) {
			...
			if (u.recurringDef) {
				...
				for (
					var d = 0, p = Mt(u, c, t, r, o.recurringTypes);
					d < p.length;
					d++
				) {
					var f = p[d],
	...
	function zt(e) {
		return (
			Ze(e.getUTCHours(), 2) +
			":" +
			Ze(e.getUTCMinutes(), 2) +
			":" +
			Ze(e.getUTCSeconds(), 2)
		);
	}
	function jt(e, t) {
		void 0 === t && (t = !1);
	...
	var Zt = {
		...
		tn = (function () {
			function e(e) {
				...
				for (var o in e)
					o in Zt
						? ((n[o] = e[o]), (r = Math.max(Zt[o], r)))
						: ((t[o] = e[o]), o in Xt && (r = Math.max(Xt[o], r)));
				(this.standardDateProps = t),
					(this.extendedSettings = n),
					(this.severity = r),
					(this.buildFormattingFunc = qt(nn));
			}
			return (
	...
	function En(e, t, n, r) {
		for (
			var o = { defs: {}, instances: {} }, i = An(n), a = 0, s = e;
			a < s.length;
			a++
		) {
	...
	function Wn(e, t) {
		...
		return (
			e.start && ((n = lt(e.start)), r && r <= n && (r = tt(n, 1))),
			{ start: n, end: r }
		);
	}
	function Vn(e) {
	...
	function Fn(e, t, n, r) {
		return "year" === r
			? Nt(n.diffWholeYears(e, t), "year")
			: "month" === r
			? Nt(n.diffWholeMonths(e, t), "month")
			: it(e, t);
	}
	function Bn(e, t) {
		var n,
	...
	function yr(e, t) {
		...
		return (
			r(
				...
				((n = e),
				(o = t.dateEnv),
				r(r({}, vr(n.range, o, n.allDay)), { allDay: n.allDay }))
			),
			i
		);
	}
	function Er(e, t, n) {
		...
		return (
			e
				? ((i = lt(i)), (i = r.add(i, o.defaultAllDayEventDuration)))
	...
	function Dr(e, t, n, o, i) {
		...
		return (
			...
			t.allDay &&
				(u.range = { start: lt(u.range.start), end: lt(u.range.end) }),
			u.range.end < u.range.start &&
				(u.range.end = Er(t.allDay, u.range.start, i)),
			u
		);
	}
	var Cr = (function () {
			...
			return (
				...
				(e.prototype.addEvent = function (e, t) {
					...
					if (s) {
						...
						return (
							this.dispatch({ type: "ADD_EVENTS", eventStore: Sn(s) }),
	...
	var Lr = (function () {
			...
			return (
				...
				(e.prototype.diffWholeMonths = function (e, t) {
					var n = this.calendarSystem;
					return gt(e) === gt(t) && n.getMarkerDay(e) === n.getMarkerDay(t)
						? n.getMarkerMonth(t) -
								n.getMarkerMonth(e) +
				...
				(e.prototype.offsetForMarker = function (e) {
					return "local" === this.timeZone
						? -pt(ft(e)).getTimezoneOffset()
						: "UTC" === this.timeZone
						? 0
						: this.namedTimeZoneImpl
						? this.namedTimeZoneImpl.offsetForArray(ft(e))
						: null;
				}),
				(e.prototype.toDate = function (e, t) {
					return "local" === this.timeZone
						...
						? new Date(
								e.valueOf() -
									1e3 * this.namedTimeZoneImpl.offsetForArray(ft(e)) * 60
						  )
	...
	function jr(e) {
		...
		return new Lr(
			r(r({ timeZone: cn.timeZone, calendarSystem: "gregory" }, e), {
				locale: t,
			})
		);
	}
	...
	function so(e, t, n, o) {
		...
		if (a.navLinks) {
			...
			return r(
				{ title: Xe(a.navLinkHint, [l, u], l), "data-navlink": "" },
				o ? He(c) : { onClick: c }
			);
		}
		return { "aria-label": l };
	...
	if (
		...
		(wo.prototype.iconClasses = {}),
		(wo.prototype.baseIconClass = ""),
		(wo.prototype.iconOverridePrefix = ""),
	...
	var Lo = (function (e) {
		...
		return (
			...
			(t.prototype.shouldComponentUpdate = function (e, t) {
				return (
					this.debug && console.log(Rt(e, this.props), Rt(t, this.state)),
					!_t(this.props, e, this.propEquality) ||
						!_t(this.state, t, this.stateEquality)
				);
			}),
			(t.prototype.safeSetState = function (e) {
				_t(this.state, r(r({}, this.state), e), this.stateEquality) ||
					this.setState(e);
			}),
		...
		return (
			...
			(t.prototype.isValidSegDownEl = function (e) {
				return (
					...
					!Se(e, ".fc-event-mirror")
				);
			}),
			(t.prototype.isValidDateDownEl = function (e) {
				return !(
					Se(e, ".fc-event:not(.fc-bg-event)") ||
					Se(e, ".fc-more-link") ||
					Se(e, "a[data-navlink]") ||
					Se(e, ".fc-popover")
				);
	...
	var Ko = (function (e) {
			...
			return (
				...
				(t.prototype.getInnerContent = function () {
					...
					return (
						void 0 === t && (t = ei(e.defaultContent, e.hookProps)),
						null == t ? null : t
					);
				}),
	...
	function Jo() {
		...
		return function (r, o) {
			return (
				(t && wt(t, o) && r === e) || ((e = r), (t = o), (n = Qo(r, o))), n
			);
		};
	}
	function Qo(e, t) {
	...
	var ai = (function () {
		function e(e) {
			(this.props = e),
				(this.nowDate = Tr(e.nowInput, e.dateEnv)),
				this.initHiddenDays();
		}
		return (
			...
			(e.prototype.buildCurrentRangeInfo = function (e, t) {
				...
				return (
					r.duration
						...
						: ((i = Vt((o = this.getFallbackDuration())).unit),
						  (a = this.buildRangeFromDuration(e, t, o, i))),
			...
			(e.prototype.adjustActiveRange = function (e) {
				...
				return (
					r &&
						(Lt(o) < 0 && ((a = lt(a)), (a = n.add(a, o))),
						Lt(i) > 1 && ((s = tt((s = lt(s)), -1)), (s = n.add(s, i)))),
					{ start: a, end: s }
				);
			}),
			(e.prototype.buildRangeFromDuration = function (e, t, n, r) {
				...
				return (
					Lt(n) <= 1 &&
						this.isHiddenDay(o) &&
						(o = lt((o = this.skipHiddenDays(o, t)))),
					d(),
			...
			(e.prototype.buildDateIncrement = function (e) {
				...
				return (
					n ||
					((t = this.props.dateAlignment) ? Nt(1, t) : e || Nt({ days: 1 }))
				);
			}),
	...
	function li(e, t, n, o) {
		...
		switch (t.type) {
			...
			case "FETCH_EVENT_SOURCES":
				return pi(
					e,
					t.sourceIds ? Dt(t.sourceIds) : hi(e, o),
					s,
					t.isRefetch || !1,
					o
				);
	...
	function ki(e, t) {
		for (
			var n = Ct(t.getCurrentData().eventSources), r = [], o = 0, i = e;
			o < i.length;
			o++
		) {
		...
		zo({
			...
			propSetHandlers: {
				dateProfile: function (e, t) {
					t.emitter.trigger(
						"datesSet",
						r(r({}, hr(e.activeRange, t.dateEnv)), { view: t.viewApi })
					);
				},
		...
		Ii = (function () {
			function e(e, t) {
				(this.runTaskOption = e),
					...
					(this.queue = []),
					(this.delayedRunner = new Mi(this.drain.bind(this)));
			}
			return (
		...
		function e(e) {
			...
			var s,
				...
				c =
					((s = o.calendarOptions),
					(l = o.dateEnv),
					null != (u = s.initialDate) ? l.createMarker(u) : Tr(s.now, l)),
			...
			Fi(g, p) && this.emitter.trigger("loading", !0),
				(this.state = g),
				this.updateData(),
		...
		return (
			...
			(e.prototype._handleAction = function (e) {
				...
				this.data &&
					...
					("PREV" !== e.type && "NEXT" !== e.type && Zn(p.currentRange, d)) ||
			...
			(e.prototype.processRawCalendarOptions = function (e, t) {
				var n = gn([cn, e, t]),
					...
					c = (this.currentCalendarOptionsRefiners = r(
						r(r(r(r({}, un), dn), pn), u.listenerRefiners),
						u.optionRefiners
					)),
					d = {},
					p = gn([cn, l, e, t]),
				...
				for (var m in p)
					"plugins" !== m &&
						(p[m] === h[m] || (fn[m] && m in h && fn[m](h[m], p[m]))
							? (f[m] = v[m])
							: c[m]
							? ((f[m] = c[m](p[m])), (g = !0))
							: (d[m] = h[m]));
			...
			(e.prototype.processRawViewOptions = function (e, t, n, o, i) {
				var a = gn([cn, e.optionDefaults, n, o, e.optionOverrides, i]),
					s = r(
						r(r(r(r(r({}, un), dn), pn), vn), t.listenerRefiners),
						t.optionRefiners
					),
					l = {},
					...
					p = {};
				for (var f in a)
					a[f] === u[f] || (fn[f] && fn[f](a[f], u[f]))
						? (l[f] = c[f])
						: (a[f] === this.currentCalendarOptionsInput[f] ||
						  (fn[f] && fn[f](a[f], this.currentCalendarOptionsInput[f]))
			...
			return (
				...
				(e.prototype.insertEntryAt = function (e, t) {
					var n = this.entriesByLevel,
						r = this.levelCoords;
					-1 === t.lateral
						? (Ji(r, t.level, t.levelCoord), Ji(n, t.level, [e]))
						: Ji(n[t.level], t.lateral, e),
						(this.stackCnts[Zi(e)] = t.stackCnt);
				}),
				(e.prototype.findInsertion = function (e) {
					...
					var S = -1;
					return (
						E < a && n[E] === s && (S = Qi(r[E], e.span.end, Yi)[0]),
						{
							touchingLevel: l,
							touchingLateral: u,
							touchingEntry: c,
	...
	var Sa = (function (e) {
		...
		Ca = (function (e) {
			function t(t, n) {
				...
				return (
					(r.initialNowDate = Tr(n.options.now, n.dateEnv)),
			...
			return (
				...
				(e.prototype.sliceNowDate = function (e, t) {
					...
					return this._sliceDateSpan.apply(
						this,
						o([{ range: { start: e, end: nt(e, 1) }, allDay: !1 }, {}, t], n)
					);
				}),
				...
				(e.prototype.sliceEventRange = function (e, t) {
					...
					this.forceDayIfListItem &&
						...
						(n = { start: n.start, end: tt(n.start, 1) });
					for (
					...
					for (var m in u) {
						...
						for (var w in f) {
							...
							if (qn(E, R.range)) {
								...
								if (C && !C(new xr(t, p[R.defId], R), new xr(t, b, y)))
									return !1;
							}
						}
						for (var _ = i.eventStore, T = 0, k = S.allows; T < k.length; T++) {
							var x = k[T],
								...
								P = _.instances[m],
								N = void 0;
							if (((N = I ? new xr(t, I, P) : new xr(t, b)), !x(yr(M, t), N)))
								return !1;
						}
					}
					return !0;
	...
	function Ba(e) {
		for (
			var t = 0, n = 0, r = De(e, ".fc-scrollgrid-shrink");
			n < r.length;
			n++
		) {
			var o = r[n];
		...
		return (
			...
			(t.prototype.renderSection = function (e, t, n) {
				return "outerContent" in e
					? _o(xo, { key: e.key }, e.outerContent)
					: _o(
							"tr",
							{
								key: e.key,
	...
	function ps(e) {
		return (
			e.event.title && _o("div", { className: "fc-event-title" }, e.event.title)
		);
	}
	var fs = function (e) {
		return _o(Oo.Consumer, null, function (t) {
			...
			return (
				...
				(t.prototype.updateSize = function () {
					var e = this.context.isRtl,
						...
						i = (function (e) {
							for (
								var t = mo(e), n = e.getBoundingClientRect(), r = 0, o = t;
								r < o.length;
								r++
							) {
					...
					if (i) {
						var a = o.getBoundingClientRect(),
							s = r
								? Se(n, ".fc-scrollgrid").getBoundingClientRect().top
								: i.top,
									...
									function (t, n, i, a) {
										return (
											...
											_o(
												...
												_o(fa, r({ isHeightAuto: i, forPrint: a }, e))
											)
										);
									}
								),
		...
		Ts = (function () {
			function e(e) {
				...
				(this.subjectEl = null),
					...
					1 === (Rs += 1) &&
						window.addEventListener("touchmove", ks, { passive: !1 });
			}
			return (
				(e.prototype.destroy = function () {
					this.containerEl.removeEventListener(
						...
						(Rs -= 1) ||
							window.removeEventListener("touchmove", ks, { passive: !1 });
				}),
				(e.prototype.tryStart = function (e) {
					var t = this.querySubjectEl(e),
						n = e.target;
					return (
						!(!t || (this.handleSelector && !Se(n, this.handleSelector))) &&
						((this.subjectEl = t),
						(this.isDragging = !0),
						(this.wasTouchScroll = !1),
						!0)
				...
				(e.prototype.handleMove = function (e, t) {
					if (this.isEnabled) {
						...
						o < 0
							...
							this.isAnimating ||
								((this.isAnimating = !0), this.requestAnimation(Ns()));
					}
				}),
				...
				(e.prototype.queryScrollEls = function (e) {
					for (var t = [], n = 0, r = this.scrollQuery; n < r.length; n++) {
						...
						"object" == typeof o
							...
							: t.push.apply(
									t,
									Array.prototype.slice.call(Te(e).querySelectorAll(o))
							  );
					}
					return t;
				}),
	...
	function Us(e, t) {
		return (
			(!e && !t) || (Boolean(e) === Boolean(t) && fr(e.dateSpan, t.dateSpan))
		);
	}
	function Ws(e, t) {
		for (
			...
			function t(t) {
				...
				(n.dragSelection = null),
					...
					(n.handlePointerUp = function (e) {
						n.dragSelection &&
							(mr(n.dragSelection, e, n.component.context),
							(n.dragSelection = null));
					});
						...
						if (e) {
							...
							i === a || (d.editable && d.droppable)
								? (s = (function (e, t, n) {
								  ...
								  ((l = Sr(n, a.getCurrentData().eventUiBases, s, a)),
								  (c.mutatedEvents = l),
								  Ia(c, e.dateProfile, a) ||
										((u = !0),
										(s = null),
										(l = null),
						...
						o.displayDrag(a, c),
							...
							t ||
								...
								o.dragging.setMirrorIsVisible(
									!e || !Te(o.subjectEl).querySelector(".fc-event-mirror")
								),
		...
		function t(t) {
			...
			(n.draggingSegEl = null),
				...
				(n.handleHitUpdate = function (e, t, r) {
					...
					l &&
						((u = Sr(i, o.getCurrentData().eventUiBases, l, o)),
						(d.mutatedEvents = u),
						Ia(d, e.dateProfile, o) ||
				...
				(this.context = e),
					...
					(this.onDocumentPointerDown = function (e) {
						...
						(t.matchesCancel = !!Se(r, n)),
							(t.matchesEvent = !!Se(r, Bs.SELECTOR));
					}),
				...
				void 0 === t && (t = {}),
					(this.handlePointerDown = function (e) {
						var t = n.dragging,
							...
							i = r.longPressDelay;
						(t.minDistance =
							null != o ? o : e.isTouch ? 0 : cn.eventDragMinDistance),
							(t.delay = e.isTouch ? (null != i ? i : cn.longPressDelay) : 0);
					}),
					(this.handleDragStart = function (e) {
						e.isTouch &&
							n.dragging.delay &&
		...
		for (var l = [], u = [], c = 0; c < e.length; c += 1) {
			...
			null != d
				? l.push({
						index: c,
						thickness: d,
						span: { start: R.firstCol, end: R.lastCol + 1 },
				  })
				: u.push(R);
		}
		for (
	...
	function _l(e) {
		...
		return _o(Oo.Consumer, null, function (n) {
			if (!e.isLabeled)
				return _o("td", { className: t.join(" "), "data-time": e.isoTimeStr });
			var r = n.dateEnv,
				o = n.options,
				i = n.viewApi,
				a =
					null == o.slotLabelFormat
						...
						? ln(o.slotLabelFormat[0])
						: ln(o.slotLabelFormat),
				s = {
					level: 0,
					time: e.time,
				...
				return (
					...
					(t.renderHeadAxis = function (e, n) {
						...
						var o = t.context.options,
							...
							a =
								1 === ot(i.start, i.end) ? so(t.context, i.start, "week") : {};
						return o.weekNumbers && "day" === e
							? _o(
									fs,
									{ date: i.start, defaultFormat: xl },
									function (e, t, o, i) {
										return _o(
											"th",
											{
									...
									content: function (e) {
										return _o(
											...
											_o(
												...
												e.tableColGroupNode,
												_o("tbody", null, _o(kl, { slatMetas: i }))
											),
											_o(
												"div",
			...
			return (
				(e.prototype.safeComputeTop = function (e) {
					...
					if (Zn(t.currentRange, e)) {
						...
						if (r >= Ut(t.slotMinTime) && r < Ut(t.slotMaxTime))
							return this.computeTimeTop(Nt(r));
					}
					return null;
				}),
				(e.prototype.computeDateTop = function (e, t) {
					return (
						t || (t = lt(e)), this.computeTimeTop(Nt(e.valueOf() - t.valueOf()))
					);
				}),
			...
			return (
				...
				(t.prototype.render = function () {
					...
					return (
						...
						_o(
							rs,
							r({}, this.props, { defaultTimeFormat: Gl, extraClassNames: e })
						)
					);
				}),
				t
			...
			return (
				...
				(t.prototype.render = function () {
					...
					return _o(
						...
						function (e, t) {
							return (
								t && _o("div", { className: "fc-timegrid-col-misc", ref: e }, t)
							);
						}
					);
				}),
		...
		Zl = (function (e) {
			...
			return (
				...
				(t.prototype.renderFillSegs = function (e, t) {
					var n = this.props,
						o = this.context,
						i = jl(e, n.date, n.slatCoords, o.options.eventMinHeight).map(
							function (o, i) {
								var a = e[i];
								return _o(
									"div",
									...
									"bg-event" === t
										? _o(ds, r({ seg: a }, sr(a, n.todayRange, n.nowDate)))
										: cs(t)
								);
							}
						);
					...
					for (var a = [], d = 0; d < c.length; d += 1) {
						...
						if (p) {
							var f = Bt(t[d]),
								h = u + "-" + f;
							a.push(
								_o(lu, { key: f, cellId: h, dayDate: t[d], todayRange: n })
							);
							for (
								var v = 0, g = (p = tr(p, i.eventOrder));
								v < g.length;
								v++
							) {
								var m = g[v];
					...
					return _o(
						...
						_o(
							...
							_o(
								"tr",
								null,
								_o("th", { scope: "col", id: s }, i.timeHint),
								_o("th", { scope: "col", "aria-hidden": !0 }),
								_o("th", { scope: "col", id: l }, i.eventHint)
							)
						),
						_o("tbody", null, a)
					);
	...
	function vu(e) {
		for (
			var t = lt(e.renderRange.start), n = e.renderRange.end, r = [], o = [];
			t < n;

		)
			r.push(t), o.push({ start: t, end: tt(t, 1) }), (t = tt(t, 1));
						...
						var u = (function (e) {
							...
							p = (function (e, t, n, o) {
								...
								o.canComputeOffset
									...
									: ((a = tt(e.start, -1).toISOString()),
									  (s = tt(e.end, 1).toISOString()));
								(i = r(r({}, n || {}), {
									key: t,
									timeMin: a,
									timeMax: s,
